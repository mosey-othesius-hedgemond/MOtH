...
#**************************************************
  ...
  #for ex. altcaps('tickle me') would return "tIcKlE Me"
...
#**************************************************
  ...
  #jam is the list containing the temps to be converted. jam must be a list and can contain floats or ints
...
def bookfiller(x):
    ...
    print(book)
#**************************************************
  #bookfiller prints a string with random characters from a list
...
def fakeemail(count):
    ...
    while y<count:
        ...
        y+=1
#**************************************************
  #fakeemail prints a number of fake email names, could be edited for a return.
